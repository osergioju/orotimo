# Cadastro de professor (inputs) — design reference
...
- `Formulario.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `Formulario.dc.html`;
