# Disponibilidade de professores — design reference
...
- `Disponibilidade.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `Disponibilidade.dc.html`;
