# Seleção de sistema — design reference
...
- `Sistemas.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `Sistemas.dc.html`;
